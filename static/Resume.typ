...
- Added tooling to deploy pre-prod infrastructure to developer AWS accounts, cutting test times by >70%.
- Wrote 5 pages of technical documentation on how to use the tooling, how to debug it, and additional plans.
- Trimmed out unnecessary build tasks on local machines, cutting local build times by >50%.
- Communicated updates and planned work over 6 Agile sprints.

// #left_right(
//   [== School Club -- Public Relations],
//   [Spring 2023 -- Spring 2025],
//   left_col: 3fr,
// )
// - Planned and hosted outreach events, promoting the club on social media to hundreds of followers.
// - Designed and commissioned NFC business cards for SJSU's Software and Computer Engineering Society
//
// #left_right(
//   [== School Esports -- Team Manager/Player],
//   [Fall 2023 - Spring 2025],
//   left_col: 2fr,
// )
// - Managed 20+ players/coaches across 2 Overwatch teams for SJSU's premier collegiate esports program.
// - Improved team skill rating by 20% over 3 months by diagnosing weak-points with Google Sheets and coaching.
...
- Lead maintainer of the largest Neovim file-tree plugin (4.9k stars on GitHub, 40k+ users).
- Refactored 3k+ of lines of Lua code to be type-annotated for ease of development.
...
- Wrote a custom backend to
- Improved parsing performance by >2x for Git statuses by optimizing hot paths and deferring work.
...
#line(length: 100%)
- *Languages:* C\#, Java, TypeScript/JavaScript, HTML, CSS (+ Less), Python, Lua, Go, C, C++, SQL
